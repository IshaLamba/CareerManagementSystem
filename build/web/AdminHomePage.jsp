    ...
    <div id="container" class="clear">
      ...
      <div id="homepage" class="clear">
        ...
        <div id="rightcolumn">
          ...
          <h2><strong>Admin Home</strong></h2>
          <ul>
              <img class="imgl" src="./images/admin.jpg"/>CMS examination system is an online site in which candidate can register themselves online and apply for job and attend the exam. Using CMS Examination systems also play a role in simplifying the Placement process.It also make possible for recruiters and companies to post their staffing requirements and view profiles of interested candidates. This is the Administrator interface using which administrator can simply monitor data of both the company and the candidate applying for job.
                      CMS Examination System enables the users to have the typical examination facilities and features at their disposal.</ul>
        </div>
        <!-- ###### -->
