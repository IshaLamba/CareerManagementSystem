...
<title>CMS| candidate:edit successful</title>
...
<link rel="stylesheet" href="styles/layout.css" type="text/css" />
    ...
    <body>
        ...
        %>
        <br/>
        <font color="red" size="5"> <%out.println("Successfully Edited!!!");%></font>
        <%
        } //try
        catch (Exception e) {
            out.println(e);
        ...
        %>
        <p>&nbsp;</p>
        <p><a href="CandidateHomePage.jsp"><strong>Go to Home</strong></a> </p>
    </body>
</html>
