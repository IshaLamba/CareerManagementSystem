...
<head>
<title>CMS |candidate Registration</title>
...
<link rel="stylesheet" href="styles/layout.css" type="text/css" />
         ...
         <script language="javascript">
            ...
            function check()
            {
                ...
                var g=document.form1.markDegree1.value;
                var e=document.form1.mobile.value;
                ...
                if(document.form1.markDegree1.value=="")
		  {

		    document.form1.markDegree1.focus();
		    return false;
		  }
                   else if(!parseInt(g))
		  {   
		      ...
		      return false;
                       ...
                       else if(parseInt(g).length<0||parseInt(g).length>100)
	               {
	               alert("Enter Degree % mark correctly  ");  
	           //    document.form1.comcutoff.value="";
                ...
                else if(((document.form1.mobile.value.length)<11) || ((document.form1.mobile.value.length)=10))
                {
    ...
    <div id="topnav">
      <ul>
       <li ><a href="index.html">Home</a></li>
        ...
        <li class="active"><a href="Registration.jsp">User Registration</a></li>
...
<div class="wrapper row3">
  <div class="rnd">
	...
	<form action="savestudentdata.jsp" method="post" name="form1" id="form1" onsubmit="return check()">
                        <table width ="100%" border="0" cellpadding="6" cellspacing="0"  align="left">
                           
                            <tr bgcolor ="#E9E9D8" width ="100%">
                                <td width="6%" bgcolor="#FEF7E9"><span class="style5"></span></td>
                                <td width="32%"><font size="2" color="black" face ="arial" >Name*</td>
                            ...
                            <tr bgcolor ="#E9E9D8">
                                ...
                                <td><table width="220" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="75"><div align="center"><font size="1" color="black" face ="arial">Degree* %</font></div></td>
                                            <td width="77"><div align="center"><font size="1" color="black" face ="arial">PG %</font></div></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <td>
                                                ...
                                                <div align="center">
                                                    <input type="text" name="markDegree1" size="5" maxlength="5" value='' onblur="checkDec('markdegree1')" />
                                        </div></td>
                            ...
                            <tr bgcolor="#E9E9D8">
                                <td bgcolor="#FEF7E9"><span class="style5"></span></td>
                                <td><font size="2" color="black" face ="arial">Mobile Number*</font></td>
